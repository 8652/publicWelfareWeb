...
class DataCreate extends Migrator
{
    /**
     * Change Method.
     *
...
-- 服务器版本： 5.7.23
-- PHP 版本： 7.2.10
DROP DATABASE IF EXISTS `publicwelfare`;
CREATE DATABASE IF NOT EXISTS publicwelfare DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE publicwelfare;
...
(1, '扬志愿精神树和谐之风展绿城之翼构卫生城市', '保护碧水蓝天，创建环保益阳', '通过组织青年志愿者的活动来改善当地周边环境 通过青年志愿者宣传提高和增强广大群众的环保意识、环保知识', '唤起社会公民环保意识，用实际行动保护我们共有的家园', '成功报名义工', '2018-12-05', '广州越秀公园', '艺术与设计学院', '着手准备展板、横幅等宣传媒介以及当天现场活动所需材料', '活动期间请各位义工要注意安全，看见乱扔垃圾的市民且误与之争吵，要好言相劝', '展板：30*10=300元　　横幅：70*1＝70元　　饮用水：35*3=105元　　医疗用品：55元', 1, -1);
...
(1, 'xy061208ab', '欧阳成功', 1, '1986-10-01', 1, '党员', '本科', '北京胡同50号', 62537485, 'cz86@sina.com');
...
";
        $_arr = explode(';', $_sql);
        $_mysqli = new mysqli('127.0.0.1:3306','root','');
